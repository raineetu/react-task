      ...
      <div className="flex flex-col md:flex-row justify-around items-center px-4 md:px-15 lg:px-24 transition-all duration-500 ">
        <div className="text-center md:text-left space-y-6 md:space-y-8 flex-1">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-700 font-bold leading-tight">
            Explore Stories, Share Ideas, and Inspire the World
          </p>
          <p className="text-gray-600 text-base sm:text-[13px] md:text-[15px] font-medium">
            Welcome to our blogging platform where creativity meets voice.
            Discover powerful stories, expert opinions, and exciting insights
            across technology, lifestyle, travel, and more. Join a community of
            writers and readers sharing knowledge and passion.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4 w-full">
            <button className="bg-gray-800 flex items-center gap-x-3 text-white px-6 py-3 rounded-lg hover:bg-gray-900 transition duration-300">
              Read Blogs <Send className="text-white w-4 h-4" />
            </button>
